...
t = tiledlayout(1,1);
ax1 = axes(t);
surf(Probe_energy, Pump_energy, ones(size(Pump_energy)), data, 'markeredgecolor', 'none', 'edgecolor', 'none', 'facecolor', 'interp', 'facealpha', 0.9)
ax1.CLim = [-0.05, 0.05];
view(0, 90)
colormap(jet(255))
...
ax1.YLim = [min(pump_energy), max(pump_energy)];
ax2 = axes(t);
ax2.FontSize = 14;
